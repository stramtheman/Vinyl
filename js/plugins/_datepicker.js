		...
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
				...
				var datetimepicker = $('<div '+(options.id?'id="'+options.id+'"':'')+' '+(options.style?'style="'+options.style+'"':'')+' class="xdsoft_datetimepicker xdsoft_noselect '+options.className+'"></div>'),
					...
					mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"><i class="icon-203"></i></button><button type="button" class="xdsoft_today_button"><i class="icon-316"></i></button><div class="xdsoft_label xdsoft_month"><span></span></div><div class="xdsoft_label xdsoft_year"><span></span></div><button type="button" class="xdsoft_next"><i class="icon-204"></i></button></div>'),
